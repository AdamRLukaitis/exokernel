h1. Welcome to kRaken!

kRaken is an exokernel operating system written in the D and Assembly programming languages. It's primarily being developed by Arcterus from http://krudmuffin.com.
...
kRaken is 64-bit and multi-core only. Support is currently on an as needed basis.
